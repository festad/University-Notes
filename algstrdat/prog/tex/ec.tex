...
\begin{frame}
    ...
    This is how a 1 is mapped in a row of $A$, where $r,c,b,n \in \{0,\dots,N-1\}$, $i \in \{0,\dots,4\cdot N^2-1\}$,
    $r$ is the row, $c$ is the column, $b$ is the box, $n$ is the element, $i$ is the index of the column:
    \begin{enumerate}
