...
\begin{frame}{Memory management}
    ...
    considered when deciding which data structure works better for the
    given task.
    ...
    runtime environment, contains the raw value of 1.
\end{frame}

\begin{frame}{}
    A list in Python is a linked list, each position $\texttt{list[i]}$ holds a pointer to the
    respective object
