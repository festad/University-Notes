    ...
    \begin{algorithmic}
        \Function{WhileCycle}{$A$, $B$, $COV$, $offset$, $filename$, $loadableRows$, $i$, $readingOffset$}
            ...
            \While{$readingOffset < i + offset$}
                \State $oldA \gets \Call{GetA}{filename, readingOffset, loadableRows}$
                ...
                \For {$j \gets 0$ to $endVal$}
                    ...
                    \Else
                        ...
                        \Else
                            ...
                            \Comment{intersect is the set of indices of rows of A that have a 1 in both columns $i + offset$ and $j + readingOffset$}
                            \If {$intersect \neq \emptyset$}
                                \State $kA \gets \Call{GetA}{filename, intersect, loadableRows}$
