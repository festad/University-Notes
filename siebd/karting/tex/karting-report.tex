...
\begin{frame}
    ...
    \begin{table}
        ...
        \hline
        Goal & The user chooses one karting center to focus on and scrolls the reviews it received. \\
        \hline
        Precondition & The user chose a karting center from a list of karting centers (obtained from any of the previous use cases).\\
        \hline
...
\begin{frame}
    ...
    \begin{table}
        ...
        \hline
        Goal & The user chooses one track to focus on and scrolls the reviews it received. \\
        \hline
        Precondition & The user chose a track from a list of tracks (obtained from any of the previous use cases).\\
        \hline
