...
\begin{frame}
    ...
    \begin{table}
        ...
        Different filtering mechanisms are made available to the user to help him throughout hhis navigation. \\
        \hline
        Profile data & None \\
        \hline
        Supergroup & None \\
...
\begin{table}
    ...
    focuses on showing him customized informations. This is not true for the access of the karting center administrator 
...
\begin{frame}
    ...
    \footnotetext{The following four slides are thought to be scrolled in full screen just to grasp the whole picture, 
